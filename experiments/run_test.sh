...
python3 train.py --dataset mnist20x20 --implementation python --batch-size 32 --eval-freq 500 --num-iterations 1000 --seed 1 --parametrization raw --forward-sampling hard -o results/raw-soft/1
