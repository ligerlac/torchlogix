...
```
python train.py --dataset cifar-10 -a ClgnCifar10Medium --device cuda --compile-model -lr 0.02 -wd 0.002
```
...
```
python train.py --dataset cifar-10 -a ClgnCifar10Medium2 --device cuda --compile-model --binarization learnable -lr 0.02 -wd 0.002
```
